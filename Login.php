...
<?php
include('conn.php');
$link=mysql_query("SELECT * FROM `upcoming6`");
{
...
<?php
include('conn.php');
$link=mysqli_query("SELECT * FROM `upcoming2`");
{
	$row=mysql_fetch_array($link);
	echo"";?><img src="<?php echo $row['Image'];?>" border="2px solid" opacity="0.5"  width="201px" height="180px" /><?php echo"";
	}
...
<span style="color: white;"><big>&nbsp;<span style="color: white;">Copyright © 2</span></big></span><big style="color: white;">020 by: Demetrio Dela Rosa <br>
